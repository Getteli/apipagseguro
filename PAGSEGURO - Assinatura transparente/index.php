...
<form id="Form2" name="Form2" method="post" action="_assets/pagseguro/create_plan_pagseguro.php">
...
<form id="Form2" name="Form2" method="post" action="_assets/pagseguro/edit_plan_pagseguro.php">
