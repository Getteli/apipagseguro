...
class PagSeguro{
	...
	private $token_sandbox = TOKEN_SANDBOX; // coloque o mesmo nos 2.
	private $token_oficial = TOKEN_SANDBOX; // coloque o mesmo nos 2.
	private $url_retorno   = ""; // Nao esta sendo usado.
